...
public:
  ...
  virtual long subscribe(std::string topic, Processor processor,
                         std::string name = "");
  virtual long subscribe(Predicate pred, Processor processor,
                         std::string name = "");
  virtual long subscribe(std::string topic, Consumer consumer,
                         std::string name = "");
  virtual long subscribe(Predicate pred, Consumer consumer,
                         std::string name = "");

  virtual long registerProcessor(std::string topic, Processor processor,
                                 std::string name = "") {
    return subscribe(topic, processor, name);
  }
  virtual long registerConsumer(std::string topic, Consumer consumer,
                                std::string name = "") {
    return subscribe(topic, consumer, name);
  }
  virtual long registerProcessor(Predicate pred, Processor processor,
                                 std::string name = "") {
    return subscribe(pred, processor, name);
  }
  virtual long registerConsumer(Predicate pred, Consumer consumer,
                                std::string name = "") {
  ...
  virtual void publish(EventPtr event, Consumer finishCallback = Consumer{},
                       bool processorsOnly = false, bool consumersOnly = false);
...
protected:
  ...
  long subscribe(std::string topic, Predicate predicate, Consumer consumer,
